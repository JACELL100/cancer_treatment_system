...
def doctor_dashboard(request):
    ...
    try:
        ...
        if not profile.profile_completed:
            return redirect('doctor_profile_complete')
    except DoctorProfile.DoesNotExist:
        # Profile doesn't exist, redirect to complete it
        return redirect('doctor_profile_complete')
    
    return render(request, 'authentication/doctor_dashboard.html')

def doctor_profile_complete(request):
    ...
    try:
        ...
        # Create a new profile with default license number
        profile = DoctorProfile.objects.create(
            user=request.user,
            license_number=f"TEMP_{request.user.id}"  # Temporary, will be updated
        )
    ...
    return render(request, 'authentication/doctor_profile_complete.html', {'form': form})
